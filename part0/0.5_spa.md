...
sequenceDiagram
    ...
    Note right of browser: Browser starts executing JavaScript code to fetch JSON
    ...
    Note right of browser: Browser executes callback function rendering the notes onto the DOM
```
